package br.com.alvinsrj.integrationtests.controller.withjson;
...
import br.com.alvinsrj.integrationtests.vo.wrappers.WrapperPersonVO;
...
public class PersonControllerJsonTest extends AbstractIntegrationTest{
	...
	public void testFindAll() throws JsonMappingException, JsonProcessingException {
		...
		var people = wrapper.getEnbedded().getPeople();
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("\"_links\":{\"self\":{\"href\":\"http://localhost:8080/api/person/v1/200\"}}}"));
		assertTrue(content.contains("\"_links\":{\"self\":{\"href\":\"http://localhost:8080/api/person/v1/687\"}}}"));
		assertTrue(content.contains("\"_links\":{\"self\":{\"href\":\"http://localhost:8080/api/person/v1/688\"}}}"));
