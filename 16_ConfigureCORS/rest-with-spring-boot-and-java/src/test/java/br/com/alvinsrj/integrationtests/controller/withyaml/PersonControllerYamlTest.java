package br.com.alvinsrj.integrationtests.controller.withyaml;
...
import br.com.alvinsrj.configs.TestConfigs;
import br.com.alvinsrj.integrationtests.controller.withyaml.mapper.YMLMapper;
import br.com.alvinsrj.integrationtests.testcontainers.AbstractIntegrationTest;
import br.com.alvinsrj.integrationtests.vo.AccountCredentialsVO;
import br.com.alvinsrj.integrationtests.vo.PersonVO;
import br.com.alvinsrj.integrationtests.vo.TokenVO;
import br.com.alvinsrj.integrationtests.vo.pagedmodels.PagedModelPerson;
...
public class PersonControllerYamlTest extends AbstractIntegrationTest{
	...
	public void testDisablePersonById() throws JsonMappingException, JsonProcessingException {
		...
		var persistedPerson = given().spec(specification)
				...
				.contentType(TestConfigs.CONTENT_TYPE_YML)
				.accept(TestConfigs.CONTENT_TYPE_YML)
					.header(TestConfigs.HEADER_PARAM_AUTHORIZATION, TestConfigs.ORIGIN_ERUDIO)
	...
	public void testFindAll() throws JsonMappingException, JsonProcessingException {
		...
		assertEquals(678,foundPersonOne.getId());
		...
		assertEquals(912,foundPersonSix.getId());
	...
	public void testHATEOAS() throws JsonMappingException, JsonProcessingException {
		...
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8080/api/person/v1/200\""));
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8080/api/person/v1/912\""));
		assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8080/api/person/v1/798\""));
