...
import br.com.alvinsrj.util.MediaType;
...
public class PersonController {
	...
	@Operation(summary = "Adds a new Person", 
		description = "Adds a new Person by passing a JSON, XML or YML of the person", 
		tags = {"People"}, 
		responses = {
			@ApiResponse(description = "Success", responseCode = "200", 
				content = @Content(schema = @Schema(implementation = PersonVO.class))), 
	...
	@Operation(summary = "Updates a Person", 
		description = "Updates Person by passing a JSON, XML or YML of the person", 
		tags = {"People"}, 
		responses = {
	...
	@PatchMapping(value = "/{id}", 
			produces = {MediaType.APPLICATION_JSON,
					MediaType.APPLICATION_XML,
					MediaType.APPLICATION_YML})
	@Operation(summary = "Disable a specific Person by their id", description = "Disable a specific Person by their id", 
		tags = {"People"}, 
		responses = {
			@ApiResponse(description = "Success", responseCode = "200", 
				content = @Content(schema = @Schema(implementation = PersonVO.class))), 
	...
	description = "Deletes a Person by passing a JSON, XML or YML of the person", 
		tags = {"People"}, 
		responses = {
			@ApiResponse(description = "No content", responseCode = "204", content = @Content), 
			@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
